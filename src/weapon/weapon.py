...
class Weapon(pygame.sprite.Sprite):
    ...
    def shoot(self, direction, group) -> None:
        self.bullets.add(Bullet(self.pos, self.w, self.h, self.color, direction, group))
...
class Pistol(Weapon):
    ...
    def calculate_direction(self, group) -> None:
        direction = self.mouse_pos - self.pos
        self.shoot(direction.normalize() * PISTOL_BULLET_SPEED, group)
